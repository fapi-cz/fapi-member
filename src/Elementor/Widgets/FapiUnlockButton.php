		...
		$this->add_control(
			...
			array(
				...
				'description'  => esc_html__(
					'Na výběr jsou jen sekce, pro které bylo povoleno nastavení "Vyžadovat dokončení úrovně"
											  v části "Postupné uvolňování obsahu" FAPI Member',
					'fapi-member'
				),
			)
		);
