...
final class FapiMemberTools {
	...
	private static $errorMap
		= array(
			...
			'apiFormCredentialsExist'     => array( 'error', 'Zadané údaje pro API se již používají.' ),
			'apiFormTooManyCredentials'   => array( 'error', 'Není možné propojit více než ' . FapiMemberPlugin::CONNECTED_API_KEYS_LIMIT . ' účtů.' ),
			'apiFormCredentialsRemoved'   => array( 'success', 'Účet byl odpojen.' ),
	...
	public static function shortcodeUnlockLevel( array $attrs )
	{
		...
		$html .= '<button type="submit" name="submit"">Odemknout úroveň</button></form>';
