...
final class FapiMemberTools {
	...
	public static function levelsSelection() {
		global $FapiPlugin;
		global $templateProvider;

		$subpage = $templateProvider->findSubpage();
	...
	public static function shortcodeSectionExpirationDate(array $attrs): string
	{
		global $FapiPlugin;
		...
		$memberships       = $membershipRepository->getActiveByUserId($user->ID);
	 ...
	 * @return string
	 */
	public static function shortcodeUnlockLevel(array $attrs): string
	{
	 ...
	 * @return string
	 */
	public static function shortcodeLevelUnlockDate(array $attrs): string
	{
		global $FapiPlugin;
		global $membershipRepository;
		...
		foreach ($memberships as $membership) {
			...
			if ($membership->getLevelId() === $parentLevel->term_id) {
	...
	public static function shortcodeLoginForm(): string
	{
		return '
	...
	public static function shortcodeUser(): string
	{
		global $FapiPlugin;
		...
		$setLoginPageId = $settingsRepository->getSetting(SettingsKey::LOGIN_PAGE);
	...
	public static function nav() {
		...
		$subpage              = $templateProvider->findSubpage();
		$areApiCredentialsSet = $apiService->areApiCredentialsSet();
