								...
								<?php if ( ! $isSection ) { ?>
                                    <div class="row">
                                        <label for="SpecifyLevelEmails[<?= $key ?>]">
                                            <input type="checkbox" id="SpecifyLevelEmails[<?= $key ?>]"
                                ...
                                <div class="inputs <?= ( $hasContentSet || $isSection ) ? '' : 'collapsed' ?>">
                                    ...
                                    <div class="row">
                                        ...
                                        <textarea name="mail_body"
                                                  id="mail_body" <?= ( $emailIsCascaded ) ? 'readonly' : '' ?>><?= ( $hasContentSet ) ? $templates[ $key ]['b'] : '' ?></textarea>
                                    </div>
