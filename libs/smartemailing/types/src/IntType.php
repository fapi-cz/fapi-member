...
abstract class IntType implements ExtractableTypeInterface
{
     ...
     * @param mixed $value
     */
    final public static function from($value): int
    {
    ...
    final public static function fromOrNull(mixed $value, bool $nullIfInvalid = \false): ?int
    {
        if ($value === null) {
            return null;
        }
     ...
     */
    final public static function extract($data, string $key): int
    {
     ...
     * @throws \SmartEmailing\Types\InvalidTypeException
     */
    final public static function extractOrNull($data, string $key, bool $nullIfInvalid = \false): ?int
    {
