...
abstract class Arrays implements ExtractableTypeInterface
{
     ...
     */
    final public static function getArrayOrNull(mixed $value, bool $nullIfInvalid = \false): ?array
    {
     ...
     */
    final public static function getIntArray(mixed $value): array
    {
     ...
     */
    final public static function getIntArrayOrNull(mixed $value, bool $nullIfInvalid = \false): ?array
    {
     ...
     */
    final public static function extractIntArrayOrNull(array $data, string $key, bool $nullIfInvalid = \false): ?array
    {
     ...
     */
    final public static function getFloatArray(mixed $value): array
    {
     ...
     */
    final public static function getFloatArrayOrNull(mixed $value, bool $nullIfInvalid = \false): ?array
    {
     ...
     */
    final public static function extractFloatArray(array $data, string $key): array
    {
     ...
     */
    final public static function extractFloatArrayOrNull(array $data, string $key, bool $nullIfInvalid = \false): ?array
    {
     ...
     */
    final public static function getStringArray(mixed $value): array
    {
     ...
     */
    final public static function getStringArrayOrNull(mixed $value, bool $nullIfInvalid = \false): ?array
    {
     ...
     */
    final public static function extractStringArrayOrNull(array $data, string $key, bool $nullIfInvalid = \false): ?array
    {
     ...
     * @return array<mixed>
     */
    public static function fromOrNull(mixed $value, bool $nullIfInvalid): ?array
    {
        if (\is_array($value)) {
            return $value;
        }
     ...
     * @return array<mixed>
     */
    public static function extract($data, string $key): array
    {
     ...
     * @return array<mixed>|null
     */
    public static function extractOrNull($data, string $key, bool $nullIfInvalid = \false): ?array
    {
