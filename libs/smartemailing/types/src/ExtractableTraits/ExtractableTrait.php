...
trait ExtractableTrait
{
     ...
     * @return self
     */
    abstract public static function from(mixed $data);
    /**
     * @param array<mixed>|\ArrayAccess<mixed, mixed> $data
     * @return self
     * @throws \SmartEmailing\Types\InvalidTypeException
     */
    public static function extract($data, string $key)
    {
     ...
     * @throws \SmartEmailing\Types\InvalidTypeException
     */
    public static function fromOrNull(mixed $value, bool $getNullIfInvalid = \false)
    {
        if ($value === null) {
            return null;
        }
     ...
     * @throws \SmartEmailing\Types\InvalidTypeException
     */
    public static function extractOrNull($data, string $key, bool $nullIfInvalid = \false)
    {
     ...
     * @throws \SmartEmailing\Types\InvalidTypeException
     */
    public static function extractArrayOf(array $data, string $key): array
    {
     ...
     * @throws \SmartEmailing\Types\InvalidTypeException
     */
    public static function extractArrayOfOrEmpty(array $data, string $key): array
    {
        if (!isset($data[$key])) {
            return [];
        }
     ...
     * @return array<self>
     */
    public static function getArrayOf(array $array): array
    {
        $return = [];
        ...
        foreach ($array as $item) {
            $return[] = ($item instanceof self) ? $item : self::from($item);
        }
        return $return;
    }
    /**
     ...
     * @return array<self>
     */
    public static function getArrayOfSkipInvalid(array $array): array
    {
        $return = [];
        if (ValidationHelpers::isTypedObjectArray($array, static::class)) {
            return $array;
     ...
     * @return array<self>
     */
    public static function extractArrayOfSkipInvalid(array $data, string $key): array
    {
        $typedArray = Arrays::extract($data, $key);
