...
abstract class ExtractableHelpers
{
     ...
     */
    final public static function extractValue($data, string $key): mixed
    {
     ...
     * @param array<mixed>|\ArrayAccess<mixed, mixed>|mixed $data
     */
    final public static function extractValueOrNull($data, string $key): mixed
    {
        if ($data instanceof ArrayAccess) {
     ...
     */
    private static function extractValueFromArray(array $data, string $key): mixed
    {
     ...
     */
    private static function extractValueFromArrayAccess(ArrayAccess $data, string $key): mixed
    {
     ...
     * @param array<mixed> $data
     */
    private static function extractValueFromArrayOrNull(array $data, string $key): mixed
    {
     ...
     * @param \ArrayAccess<mixed, mixed> $data
     */
    private static function extractValueFromArrayAccessOrNull(ArrayAccess $data, string $key): mixed
    {
        if (!$data->offsetExists($key)) {
            return null;
        }
