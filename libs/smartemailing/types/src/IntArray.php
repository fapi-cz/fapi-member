...
abstract class IntArray implements ExtractableTypeInterface
{
     ...
     * @return array<int>
     */
    final public static function from(mixed $value): array
    {
     ...
     */
    final public static function fromOrNull(mixed $value, bool $nullIfInvalid = \false): ?array
    {
     ...
     */
    final public static function extract($data, string $key): array
    {
     ...
     * @throws \SmartEmailing\Types\InvalidTypeException
     */
    final public static function extractOrNull($data, string $key, bool $nullIfInvalid = \false): ?array
    {
