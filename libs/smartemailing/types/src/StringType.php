...
{
    final public static function from(mixed $value): string
    {
        if (\is_scalar($value)) {
            return (string) $value;
        }
    ...
    final public static function fromOrNull(mixed $value, bool $nullIfInvalid = \false): ?string
    {
        if ($value === null) {
            return null;
        }
     ...
     */
    final public static function extract($data, string $key): string
    {
     ...
     * @throws \SmartEmailing\Types\InvalidTypeException
     */
    final public static function extractOrNull($data, string $key, bool $nullIfInvalid = \false): ?string
    {
