...
namespace FapiMember\Library\PhpParser;

use FapiMember\Library\PhpParser\Internal\DiffElem;
use FapiMember\Library\PhpParser\Internal\Differ;
use FapiMember\Library\PhpParser\Internal\PrintableNewAnonClassNode;
use FapiMember\Library\PhpParser\Internal\TokenStream;
use FapiMember\Library\PhpParser\Node\AttributeGroup;
...
use FapiMember\Library\PhpParser\Node\Scalar;
...
abstract class PrettyPrinterAbstract implements PrettyPrinter
{
    ...
    {
        return (($modifiers & Modifiers::FINAL) ? 'final ' : '') . (($modifiers & Modifiers::ABSTRACT) ? 'abstract ' : '') . (($modifiers & Modifiers::PUBLIC) ? 'public ' : '') . (($modifiers & Modifiers::PROTECTED) ? 'protected ' : '') . (($modifiers & Modifiers::PRIVATE) ? 'private ' : '') . (($modifiers & Modifiers::STATIC) ? 'static ' : '') . (($modifiers & Modifiers::READONLY) ? 'readonly ' : '');
    }
    ...
    protected function initializeModifierChangeMap(): void
    {
        ...
        $this->modifierChangeMap = [Stmt\ClassConst::class . '->flags' => ['pModifiers', \T_CONST], Stmt\ClassMethod::class . '->flags' => ['pModifiers', \T_FUNCTION], Stmt\Class_::class . '->flags' => ['pModifiers', \T_CLASS], Stmt\Property::class . '->flags' => ['pModifiers', \T_VARIABLE], PrintableNewAnonClassNode::class . '->flags' => ['pModifiers', \T_CLASS], Param::class . '->flags' => ['pModifiers', \T_VARIABLE], Expr\Closure::class . '->static' => ['pStatic', \T_FUNCTION], Expr\ArrowFunction::class . '->static' => ['pStatic', \T_FN]];
