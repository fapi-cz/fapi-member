...
namespace FapiMember\Library\PhpParser\Lexer;
...
use FapiMember\Library\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use FapiMember\Library\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use FapiMember\Library\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use FapiMember\Library\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use FapiMember\Library\PhpParser\Lexer\TokenEmulator\FlexibleDocStringEmulator;
use FapiMember\Library\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use FapiMember\Library\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use FapiMember\Library\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use FapiMember\Library\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use FapiMember\Library\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use FapiMember\Library\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use FapiMember\Library\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use FapiMember\Library\PhpParser\Lexer\TokenEmulator\TokenEmulator;
...
class Emulative extends Lexer
{
    ...
    public function __construct(?PhpVersion $phpVersion = null)
    {
        ...
        $emulators = [new MatchTokenEmulator(), new NullsafeTokenEmulator(), new AttributeEmulator(), new EnumTokenEmulator(), new ReadonlyTokenEmulator(), new ExplicitOctalEmulator(), new ReadonlyFunctionTokenEmulator()];
