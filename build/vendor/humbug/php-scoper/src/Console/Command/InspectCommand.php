...
use FapiMember\Library\Fidry\Console\Command\CommandAwareness;
use FapiMember\Library\Fidry\Console\Command\Configuration as CommandConfiguration;
use FapiMember\Library\Fidry\Console\ExitCode;
...
use FapiMember\Library\Humbug\PhpScoper\Console\ConfigLoader;
...
use FapiMember\Library\Symfony\Component\VarDumper\Cloner\VarCloner;
use FapiMember\Library\Symfony\Component\VarDumper\Dumper\CliDumper;
...
final class InspectCommand implements Command, CommandAware
{
    ...
    private function scopeFile(Configuration $config, SymbolsRegistry $symbolsRegistry, string $filePath, string $fileContents): string
    {
