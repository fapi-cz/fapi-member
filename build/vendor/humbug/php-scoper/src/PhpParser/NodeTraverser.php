...
use FapiMember\Library\Humbug\PhpScoper\PhpParser\Node\NameFactory;
use FapiMember\Library\PhpParser\Node;
use FapiMember\Library\PhpParser\Node\Stmt;
use FapiMember\Library\PhpParser\Node\Stmt\Declare_;
use FapiMember\Library\PhpParser\Node\Stmt\GroupUse;
use FapiMember\Library\PhpParser\Node\Stmt\InlineHTML;
...
use FapiMember\Library\PhpParser\NodeVisitor;
