...
use FapiMember\Library\Humbug\PhpScoper\PhpParser\NodeVisitor\Resolver\OriginalNameResolver;
use FapiMember\Library\Humbug\PhpScoper\PhpParser\NodeVisitor\UseStmt\UseStmtCollection;
use FapiMember\Library\Humbug\PhpScoper\PhpParser\UseStmtName;
use FapiMember\Library\Humbug\PhpScoper\Symbol\EnrichedReflector;
use FapiMember\Library\PhpParser\Node;
use FapiMember\Library\PhpParser\Node\Attribute;
use FapiMember\Library\PhpParser\Node\Expr\ArrowFunction;
use FapiMember\Library\PhpParser\Node\Expr\ClassConstFetch;
use FapiMember\Library\PhpParser\Node\Expr\Closure;
use FapiMember\Library\PhpParser\Node\Expr\ConstFetch;
use FapiMember\Library\PhpParser\Node\Expr\FuncCall;
use FapiMember\Library\PhpParser\Node\Expr\Instanceof_;
use FapiMember\Library\PhpParser\Node\Expr\New_;
use FapiMember\Library\PhpParser\Node\Expr\StaticCall;
use FapiMember\Library\PhpParser\Node\Expr\StaticPropertyFetch;
use FapiMember\Library\PhpParser\Node\IntersectionType;
use FapiMember\Library\PhpParser\Node\Name;
use FapiMember\Library\PhpParser\Node\Name\FullyQualified;
use FapiMember\Library\PhpParser\Node\NullableType;
use FapiMember\Library\PhpParser\Node\Param;
use FapiMember\Library\PhpParser\Node\Stmt\Catch_;
use FapiMember\Library\PhpParser\Node\Stmt\Class_;
use FapiMember\Library\PhpParser\Node\Stmt\ClassMethod;
use FapiMember\Library\PhpParser\Node\Stmt\Function_;
use FapiMember\Library\PhpParser\Node\Stmt\Interface_;
use FapiMember\Library\PhpParser\Node\Stmt\Property;
use FapiMember\Library\PhpParser\Node\Stmt\TraitUse;
use FapiMember\Library\PhpParser\Node\Stmt\TraitUseAdaptation\Alias;
use FapiMember\Library\PhpParser\Node\Stmt\TraitUseAdaptation\Precedence;
use FapiMember\Library\PhpParser\Node\Stmt\Use_;
use FapiMember\Library\PhpParser\Node\UnionType;
