...
use FapiMember\Library\PhpParser\Node\ArrayItem;
use FapiMember\Library\PhpParser\Node\Const_;
use FapiMember\Library\PhpParser\Node\Expr\Array_;
use FapiMember\Library\PhpParser\Node\Expr\Assign;
...
use FapiMember\Library\PhpParser\Node\Stmt\PropertyProperty;
use FapiMember\Library\PhpParser\Node\Stmt\Return_;
...
final class StringScalarPrefixer extends NodeVisitorAbstract
{
    ...
    private const SPECIAL_FUNCTION_NAMES = ['call_user_func_array', 'class_alias', 'class_exists', 'define', 'defined', 'function_exists', 'interface_exists', 'is_a', 'is_callable', 'is_subclass_of', 'spl_autoload_register', 'trait_exists'];
