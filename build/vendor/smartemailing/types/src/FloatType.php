...
{
    final public static function from(mixed $value): float
    {
        if (\is_string($value)) {
            $value = \strtr($value, [',' => '.']);
        }
    ...
    final public static function fromOrNull(mixed $value, bool $nullIfInvalid = \false): ?float
    {
        if ($value === null) {
            return null;
        }
     ...
     */
    final public static function extract($data, string $key): float
    {
     ...
     */
    final public static function extractOrNull($data, string $key, bool $nullIfInvalid = \false): ?float
    {
