...
{
    final public static function from(mixed $value): \DateTime
    {
        ...
        throw new InvalidTypeException('Value ' . $value . ' must be string in ' . DateTimeFormat::DATETIME . ' format');
    }
    /**
     * @param array<mixed>|\ArrayAccess<mixed, mixed> $data
     * @throws \SmartEmailing\Types\InvalidTypeException
     */
    final public static function extract($data, string $key): \DateTime
    {
     ...
     * @param array<mixed>|\ArrayAccess<mixed, mixed> $data
     */
    final public static function extractOrNull($data, string $key, bool $nullIfInvalid = \false): ?\DateTime
    {
     ...
     */
    final public static function extractDate(array &$data, string $key): \DateTime
    {
     ...
     */
    final public static function extractDateOrNull(array &$data, string $key): ?\DateTime
    {
        return Dates::extractOrNull($data, $key);
    }
    public static function fromOrNull(mixed $value, bool $nullIfInvalid = \false): ?\DateTime
    {
        if ($value === null) {
            return null;
        }
