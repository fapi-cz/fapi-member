...
abstract class PrimitiveTypes
{
     ...
     */
    final public static function getInt(mixed $value): int
    {
     ...
     */
    final public static function getIntOrNull(mixed $value, bool $nullIfInvalid = \false): ?int
    {
     ...
     */
    final public static function extractInt(array $data, string $key): int
    {
     ...
     */
    final public static function extractIntOrNull(array $data, string $key, bool $nullIfInvalid = \false): ?int
    {
     ...
     */
    final public static function getFloat(mixed $value): float
    {
     ...
     */
    final public static function getFloatOrNull(mixed $value, bool $nullIfInvalid = \false): ?float
    {
     ...
     */
    final public static function extractFloat(array $data, string $key): float
    {
     ...
     */
    final public static function extractFloatOrNull(array $data, string $key, bool $nullIfInvalid = \false): ?float
    {
     ...
     */
    final public static function getString(mixed $value): string
    {
     ...
     */
    final public static function getStringOrNull(mixed $value, bool $nullIfInvalid = \false): ?string
    {
     ...
     */
    final public static function extractString(array $data, string $key): string
    {
     ...
     */
    final public static function extractStringOrNull(array $data, string $key, bool $nullIfInvalid = \false): ?string
    {
     ...
     */
    final public static function getBool(mixed $value): bool
    {
     ...
     */
    final public static function getBoolOrNull(mixed $value, bool $nullIfInvalid = \false): ?bool
    {
     ...
     */
    final public static function extractBool(array $data, string $key): bool
    {
     ...
     */
    final public static function extractBoolOrNull(array $data, string $key, bool $nullIfInvalid = \false): ?bool
    {
     ...
     */
    final public static function getArray(mixed $value): array
    {
    ...
    {
        return Arrays::extract($data, $key);
    }
    /**
     * Preserves keys
     *
     ...
     */
    final public static function extractArrayOrNull(array &$data, string $key, bool $nullIfInvalid = \false): ?array
    {
        return Arrays::extractOrNull($data, $key, $nullIfInvalid);
    }
    /**
     * @param array<mixed> $data
     * @return array<string>
     ...
     */
    final public static function extractStringArray(array $data, string $key): array
    {
     ...
     */
    final public static function extractIntArray(array $data, string $key): array
    {
