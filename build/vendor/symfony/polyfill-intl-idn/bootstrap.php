 ...
 */
use FapiMember\Library\Symfony\Polyfill\Intl\Idn as p;
...
if (\PHP_VERSION_ID < 70400) {
    if (!\function_exists('idn_to_ascii') && !\function_exists('FapiMember\Library\idn_to_ascii')) {
    ...
    if (!\function_exists('idn_to_utf8') && !\function_exists('FapiMember\Library\idn_to_utf8')) {
