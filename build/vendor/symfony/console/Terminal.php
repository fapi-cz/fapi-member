...
use FapiMember\Library\Symfony\Component\Console\Output\AnsiColorMode;
class Terminal
{
    ...
    public static function hasSttyAvailable(): bool
    {
        ...
        if (!\function_exists('shell_exec') && !\function_exists('FapiMember\Library\shell_exec')) {
            return \false;
        }
    ...
    {
        if (!\function_exists('proc_open') && !\function_exists('FapiMember\Library\proc_open')) {
            return null;
        }
