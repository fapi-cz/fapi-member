 ...
 */
namespace FapiMember\Library\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'FapiMember\Library\mes\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'FapiMember\Library\Mes\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'FapiMember\Library\ma\1'],
        ['/^Mes(dame|demoiselle)s$/', 'FapiMember\Library\Ma\1'],
        ['/^mes(sieur|seigneur)s$/', 'FapiMember\Library\mon\1'],
        ['/^Mes(sieur|seigneur)s$/', 'FapiMember\Library\Mon\1'],
        // Default rule
        ['/s$/i', ''],
    ];
