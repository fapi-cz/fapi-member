 ...
 */
use FapiMember\Library\Symfony\Polyfill\Intl\Grapheme as p;
...
if (!\function_exists('grapheme_extract') && !\function_exists('FapiMember\Library\grapheme_extract')) {
...
if (!\function_exists('grapheme_stripos') && !\function_exists('FapiMember\Library\grapheme_stripos')) {
...
if (!\function_exists('grapheme_stristr') && !\function_exists('FapiMember\Library\grapheme_stristr')) {
...
if (!\function_exists('grapheme_strlen') && !\function_exists('FapiMember\Library\grapheme_strlen')) {
    function grapheme_strlen(?string $string): int|false|null
    {
        return p\Grapheme::grapheme_strlen((string) $string);
    }
}
if (!\function_exists('grapheme_strpos') && !\function_exists('FapiMember\Library\grapheme_strpos')) {
...
if (!\function_exists('grapheme_strripos') && !\function_exists('FapiMember\Library\grapheme_strripos')) {
...
if (!\function_exists('grapheme_strrpos') && !\function_exists('FapiMember\Library\grapheme_strrpos')) {
...
if (!\function_exists('grapheme_strstr') && !\function_exists('FapiMember\Library\grapheme_strstr')) {
...
if (!\function_exists('grapheme_substr') && !\function_exists('FapiMember\Library\grapheme_substr')) {
