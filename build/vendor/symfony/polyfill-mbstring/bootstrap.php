 ...
 */
use FapiMember\Library\Symfony\Polyfill\Mbstring as p;
if (\PHP_VERSION_ID >= 80000) {
    return require __DIR__ . '/bootstrap80.php';
}
if (!\function_exists('mb_convert_encoding') && !\function_exists('FapiMember\Library\mb_convert_encoding')) {
...
if (!\function_exists('mb_decode_mimeheader') && !\function_exists('FapiMember\Library\mb_decode_mimeheader')) {
    function mb_decode_mimeheader($string)
    {
        return p\Mbstring::mb_decode_mimeheader($string);
    }
}
if (!\function_exists('mb_encode_mimeheader') && !\function_exists('FapiMember\Library\mb_encode_mimeheader')) {
    function mb_encode_mimeheader($string, $charset = null, $transfer_encoding = null, $newline = "\r\n", $indent = 0)
    {
        return p\Mbstring::mb_encode_mimeheader($string, $charset, $transfer_encoding, $newline, $indent);
    }
}
if (!\function_exists('mb_decode_numericentity') && !\function_exists('FapiMember\Library\mb_decode_numericentity')) {
    function mb_decode_numericentity($string, $map, $encoding = null)
    {
        return p\Mbstring::mb_decode_numericentity($string, $map, $encoding);
    }
}
if (!\function_exists('mb_encode_numericentity') && !\function_exists('FapiMember\Library\mb_encode_numericentity')) {
...
if (!\function_exists('mb_convert_case') && !\function_exists('FapiMember\Library\mb_convert_case')) {
    function mb_convert_case($string, $mode, $encoding = null)
    {
        return p\Mbstring::mb_convert_case($string, $mode, $encoding);
    }
}
if (!\function_exists('mb_internal_encoding') && !\function_exists('FapiMember\Library\mb_internal_encoding')) {
    function mb_internal_encoding($encoding = null)
    {
        return p\Mbstring::mb_internal_encoding($encoding);
    }
}
if (!\function_exists('mb_language') && !\function_exists('FapiMember\Library\mb_language')) {
    function mb_language($language = null)
    {
        return p\Mbstring::mb_language($language);
    }
}
if (!\function_exists('mb_list_encodings') && !\function_exists('FapiMember\Library\mb_list_encodings')) {
    function mb_list_encodings()
    {
        return p\Mbstring::mb_list_encodings();
    }
}
if (!\function_exists('mb_encoding_aliases') && !\function_exists('FapiMember\Library\mb_encoding_aliases')) {
    function mb_encoding_aliases($encoding)
    {
        return p\Mbstring::mb_encoding_aliases($encoding);
    }
}
if (!\function_exists('mb_check_encoding') && !\function_exists('FapiMember\Library\mb_check_encoding')) {
    function mb_check_encoding($value = null, $encoding = null)
    {
        return p\Mbstring::mb_check_encoding($value, $encoding);
    }
}
if (!\function_exists('mb_detect_encoding') && !\function_exists('FapiMember\Library\mb_detect_encoding')) {
...
if (!\function_exists('mb_detect_order') && !\function_exists('FapiMember\Library\mb_detect_order')) {
    function mb_detect_order($encoding = null)
    {
        return p\Mbstring::mb_detect_order($encoding);
    }
}
if (!\function_exists('mb_parse_str') && !\function_exists('FapiMember\Library\mb_parse_str')) {
...
if (!\function_exists('mb_strlen') && !\function_exists('FapiMember\Library\mb_strlen')) {
    function mb_strlen($string, $encoding = null)
    {
        return p\Mbstring::mb_strlen($string, $encoding);
    }
}
if (!\function_exists('mb_strpos') && !\function_exists('FapiMember\Library\mb_strpos')) {
    function mb_strpos($haystack, $needle, $offset = 0, $encoding = null)
    {
        return p\Mbstring::mb_strpos($haystack, $needle, $offset, $encoding);
    }
}
if (!\function_exists('mb_strtolower') && !\function_exists('FapiMember\Library\mb_strtolower')) {
    function mb_strtolower($string, $encoding = null)
    {
        return p\Mbstring::mb_strtolower($string, $encoding);
    }
}
if (!\function_exists('mb_strtoupper') && !\function_exists('FapiMember\Library\mb_strtoupper')) {
    function mb_strtoupper($string, $encoding = null)
    {
        return p\Mbstring::mb_strtoupper($string, $encoding);
    }
}
if (!\function_exists('mb_substitute_character') && !\function_exists('FapiMember\Library\mb_substitute_character')) {
    function mb_substitute_character($substitute_character = null)
    {
        return p\Mbstring::mb_substitute_character($substitute_character);
    }
}
if (!\function_exists('mb_substr') && !\function_exists('FapiMember\Library\mb_substr')) {
    function mb_substr($string, $start, $length = 2147483647, $encoding = null)
    {
        return p\Mbstring::mb_substr($string, $start, $length, $encoding);
    }
}
if (!\function_exists('mb_stripos') && !\function_exists('FapiMember\Library\mb_stripos')) {
    function mb_stripos($haystack, $needle, $offset = 0, $encoding = null)
    {
        return p\Mbstring::mb_stripos($haystack, $needle, $offset, $encoding);
    }
}
if (!\function_exists('mb_stristr') && !\function_exists('FapiMember\Library\mb_stristr')) {
...
if (!\function_exists('mb_strrchr') && !\function_exists('FapiMember\Library\mb_strrchr')) {
...
if (!\function_exists('mb_strrichr') && !\function_exists('FapiMember\Library\mb_strrichr')) {
...
if (!\function_exists('mb_strripos') && !\function_exists('FapiMember\Library\mb_strripos')) {
    function mb_strripos($haystack, $needle, $offset = 0, $encoding = null)
    {
        return p\Mbstring::mb_strripos($haystack, $needle, $offset, $encoding);
    }
}
if (!\function_exists('mb_strrpos') && !\function_exists('FapiMember\Library\mb_strrpos')) {
    function mb_strrpos($haystack, $needle, $offset = 0, $encoding = null)
    {
        return p\Mbstring::mb_strrpos($haystack, $needle, $offset, $encoding);
    }
}
if (!\function_exists('mb_strstr') && !\function_exists('FapiMember\Library\mb_strstr')) {
...
if (!\function_exists('mb_get_info') && !\function_exists('FapiMember\Library\mb_get_info')) {
    function mb_get_info($type = 'all')
    {
        return p\Mbstring::mb_get_info($type);
    }
}
if (!\function_exists('mb_http_output') && !\function_exists('FapiMember\Library\mb_http_output')) {
    function mb_http_output($encoding = null)
    {
        return p\Mbstring::mb_http_output($encoding);
    }
}
if (!\function_exists('mb_strwidth') && !\function_exists('FapiMember\Library\mb_strwidth')) {
    function mb_strwidth($string, $encoding = null)
    {
        return p\Mbstring::mb_strwidth($string, $encoding);
    }
}
if (!\function_exists('mb_substr_count') && !\function_exists('FapiMember\Library\mb_substr_count')) {
    function mb_substr_count($haystack, $needle, $encoding = null)
    {
        return p\Mbstring::mb_substr_count($haystack, $needle, $encoding);
    }
}
if (!\function_exists('mb_output_handler') && !\function_exists('FapiMember\Library\mb_output_handler')) {
    function mb_output_handler($string, $status)
    {
        return p\Mbstring::mb_output_handler($string, $status);
    }
}
if (!\function_exists('mb_http_input') && !\function_exists('FapiMember\Library\mb_http_input')) {
    function mb_http_input($type = null)
    {
        return p\Mbstring::mb_http_input($type);
    }
}
if (!\function_exists('mb_convert_variables') && !\function_exists('FapiMember\Library\mb_convert_variables')) {
    function mb_convert_variables($to_encoding, $from_encoding, &...$vars)
    {
        return p\Mbstring::mb_convert_variables($to_encoding, $from_encoding, ...$vars);
    }
}
if (!\function_exists('mb_ord') && !\function_exists('FapiMember\Library\mb_ord')) {
    function mb_ord($string, $encoding = null)
    {
        return p\Mbstring::mb_ord($string, $encoding);
    }
}
if (!\function_exists('mb_chr') && !\function_exists('FapiMember\Library\mb_chr')) {
    function mb_chr($codepoint, $encoding = null)
    {
        return p\Mbstring::mb_chr($codepoint, $encoding);
    }
}
if (!\function_exists('mb_scrub') && !\function_exists('FapiMember\Library\mb_scrub')) {
...
if (!\function_exists('mb_str_split') && !\function_exists('FapiMember\Library\mb_str_split')) {
    function mb_str_split($string, $length = 1, $encoding = null)
    {
        return p\Mbstring::mb_str_split($string, $length, $encoding);
    }
}
if (!\function_exists('mb_str_pad') && !\function_exists('FapiMember\Library\mb_str_pad')) {
