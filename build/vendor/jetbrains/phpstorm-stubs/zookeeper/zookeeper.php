 ...
 * @link https://www.php.net/manual/en/class.zookeeper.php
 */
\class_alias('FapiMember\Library\Zookeeper', 'Zookeeper', \false);
class ZookeeperException extends \Exception
{
}
\class_alias('FapiMember\Library\ZookeeperException', 'ZookeeperException', \false);
class ZookeeperOperationTimeoutException extends \ZookeeperException
{
}
\class_alias('FapiMember\Library\ZookeeperOperationTimeoutException', 'ZookeeperOperationTimeoutException', \false);
class ZookeeperConnectionException extends \ZookeeperException
{
}
\class_alias('FapiMember\Library\ZookeeperConnectionException', 'ZookeeperConnectionException', \false);
class ZookeeperMarshallingException extends \ZookeeperException
{
}
\class_alias('FapiMember\Library\ZookeeperMarshallingException', 'ZookeeperMarshallingException', \false);
class ZookeeperAuthenticationException extends \ZookeeperException
{
}
\class_alias('FapiMember\Library\ZookeeperAuthenticationException', 'ZookeeperAuthenticationException', \false);
class ZookeeperSessionException extends \ZookeeperException
{
}
\class_alias('FapiMember\Library\ZookeeperSessionException', 'ZookeeperSessionException', \false);
class ZookeeperNoNodeException extends \ZookeeperException
{
}
\class_alias('FapiMember\Library\ZookeeperNoNodeException', 'ZookeeperNoNodeException', \false);
