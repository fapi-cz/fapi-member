 ...
 * created using:
 */
\class_alias('FapiMember\Library\classObj', 'classObj', \false);
/**
 ...
 * Instance of clusterObj is always embedded inside the `layerObj`_.
 */
\class_alias('FapiMember\Library\clusterObj', 'clusterObj', \false);
/**
 ...
 * Instances of colorObj are always embedded inside other classes.
 */
\class_alias('FapiMember\Library\colorObj', 'colorObj', \false);
...
\class_alias('FapiMember\Library\errorObj', 'errorObj', \false);
/**
 ...
 * $oLayer->grid->set("labelformat", "DDMMSS");
 */
\class_alias('FapiMember\Library\gridObj', 'gridObj', \false);
/**
 ...
 * echo "Key: ".$key." value: ".$hashTable->get($key)."<br/>";
 */
\class_alias('FapiMember\Library\hashTableObj', 'hashTableObj', \false);
/**
 ...
 * Instances of imageObj are always created by the `mapObj`_ class methods.
 */
\class_alias('FapiMember\Library\imageObj', 'imageObj', \false);
...
\class_alias('FapiMember\Library\labelcacheMemberObj', 'labelcacheMemberObj', \false);
...
\class_alias('FapiMember\Library\labelcacheObj', 'labelcacheObj', \false);
/**
 ...
 * labelObj are always embedded inside other classes.
 */
\class_alias('FapiMember\Library\labelObj', 'labelObj', \false);
/**
 ...
 * layer created.
 */
\class_alias('FapiMember\Library\layerObj', 'layerObj', \false);
/**
 ...
 * Instances of legendObj are always are always embedded inside the `mapObj`_.
 */
\class_alias('FapiMember\Library\legendObj', 'legendObj', \false);
final class lineObj
{
    /**
     * read-only
...
\class_alias('FapiMember\Library\lineObj', 'lineObj', \false);
final class mapObj
{
    /**
     * @var float
...
\class_alias('FapiMember\Library\mapObj', 'mapObj', \false);
/**
 ...
 * No constructor available (coming soon, see ticket 979)
 */
\class_alias('FapiMember\Library\outputformatObj', 'outputformatObj', \false);
...
\class_alias('FapiMember\Library\OwsrequestObj', 'OwsrequestObj', \false);
...
\class_alias('FapiMember\Library\pointObj', 'pointObj', \false);
...
\class_alias('FapiMember\Library\projectionObj', 'projectionObj', \false);
/**
 ...
 * `mapObj`_.
 */
\class_alias('FapiMember\Library\querymapObj', 'querymapObj', \false);
/**
 ...
 * also be created with:
 */
\class_alias('FapiMember\Library\rectObj', 'rectObj', \false);
/**
 ...
 * Instances of referenceMapObj are always embedded inside the `mapObj`_.
 */
\class_alias('FapiMember\Library\referenceMapObj', 'referenceMapObj', \false);
...
\class_alias('FapiMember\Library\resultObj', 'resultObj', \false);
/**
 ...
 * Instances of scalebarObj are always embedded inside the `mapObj`_.
 */
\class_alias('FapiMember\Library\scalebarObj', 'scalebarObj', \false);
...
\class_alias('FapiMember\Library\shapefileObj', 'shapefileObj', \false);
...
\class_alias('FapiMember\Library\shapeObj', 'shapeObj', \false);
/**
 ...
 * Instances of styleObj are always embedded inside a `classObj`_ or `labelObj`_.
 */
\class_alias('FapiMember\Library\styleObj', 'styleObj', \false);
...
\class_alias('FapiMember\Library\symbolObj', 'symbolObj', \false);
/**
 ...
 * Instances of webObj are always are always embedded inside the `mapObj`_.
 */
\class_alias('FapiMember\Library\webObj', 'webObj', \false);
