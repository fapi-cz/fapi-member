 ...
 * @since 7.2
 */
function ftp_mlsd(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, string $directory): array|false
{
}
/**
 ...
 */
function ftp_login(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, string $username, string $password): bool
{
}
/**
 ...
 */
function ftp_pwd(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp): string|false
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ftp_cdup(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp): bool
{
}
/**
 ...
 */
function ftp_chdir(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, string $directory): bool
{
}
/**
 ...
 */
function ftp_exec(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, string $command): bool
{
}
/**
...
function ftp_raw(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, string $command)
{
}
/**
 * Creates a directory
 ...
 */
function ftp_mkdir(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, string $directory): string|false
{
}
/**
 * Removes a directory
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ftp_rmdir(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, string $directory): bool
{
}
/**
 ...
 */
function ftp_chmod(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, int $permissions, string $filename): int|false
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ftp_alloc(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, int $size, &$response): bool
{
}
/**
 * Returns a list of files in the given directory
 ...
 * <b>FALSE</b> on error.
 */
function ftp_nlist(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, string $directory): array|false
{
}
/**
 ...
 * </p>
 */
function ftp_rawlist(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, string $directory, bool $recursive = \false): array|false
{
}
/**
 ...
 */
function ftp_systype(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp): string|false
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ftp_pasv(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, bool $enable): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ftp_get(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, string $local_filename, string $remote_filename, #[EV([\FTP_ASCII, \FTP_BINARY])] #[PhpStormStubsElementAvailable(from: '5.3', to: '7.2')] int $mode, #[EV([\FTP_ASCII, \FTP_BINARY])] #[PhpStormStubsElementAvailable(from: '7.3')] int $mode = \FTP_BINARY, int $offset = 0): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ftp_fget(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, $stream, string $remote_filename, #[EV([\FTP_ASCII, \FTP_BINARY])] #[PhpStormStubsElementAvailable(from: '5.3', to: '7.2')] int $mode, #[EV([\FTP_ASCII, \FTP_BINARY])] #[PhpStormStubsElementAvailable(from: '7.3')] int $mode = \FTP_BINARY, int $offset = 0): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ftp_put(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, string $remote_filename, string $local_filename, #[EV([\FTP_ASCII, \FTP_BINARY])] #[PhpStormStubsElementAvailable(from: '5.3', to: '7.2')] int $mode, #[EV([\FTP_ASCII, \FTP_BINARY])] #[PhpStormStubsElementAvailable(from: '7.3')] int $mode = \FTP_BINARY, int $offset = 0): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ftp_fput(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, string $remote_filename, $stream, #[EV([\FTP_ASCII, \FTP_BINARY])] #[PhpStormStubsElementAvailable(from: '5.3', to: '7.2')] int $mode, #[EV([\FTP_ASCII, \FTP_BINARY])] #[PhpStormStubsElementAvailable(from: '7.3')] int $mode = \FTP_BINARY, int $offset = 0): bool
{
}
/**
 ...
 */
function ftp_size(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, string $filename): int
{
}
/**
 ...
 * error.
 */
function ftp_mdtm(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, string $filename): int
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ftp_rename(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, string $from, string $to): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ftp_delete(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, string $filename): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ftp_site(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, string $command): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ftp_close(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp): bool
{
}
/**
 ...
 */
function ftp_set_option(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, #[EV(flags: [\FTP_TIMEOUT_SEC, \FTP_AUTOSEEK, \FTP_USEPASVADDRESS])] int $option, $value): bool
{
}
/**
 ...
 */
function ftp_get_option(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, #[EV(flags: [\FTP_TIMEOUT_SEC, \FTP_AUTOSEEK])] int $option): int|bool
{
}
/**
...
function ftp_nb_fget(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, $stream, string $remote_filename, #[EV([\FTP_ASCII, \FTP_BINARY])] #[PhpStormStubsElementAvailable(from: '5.3', to: '7.2')] int $mode, #[EV([\FTP_ASCII, \FTP_BINARY])] #[PhpStormStubsElementAvailable(from: '7.3')] int $mode = \FTP_BINARY, int $offset = 0): int
{
}
/**
...
function ftp_nb_get(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, string $local_filename, string $remote_filename, #[EV([\FTP_ASCII, \FTP_BINARY])] #[PhpStormStubsElementAvailable(from: '5.3', to: '7.2')] int $mode, #[EV([\FTP_ASCII, \FTP_BINARY])] #[PhpStormStubsElementAvailable(from: '7.3')] int $mode = \FTP_BINARY, int $offset = 0)
{
}
/**
 ...
 */
#[EV([\FTP_FAILED, \FTP_FINISHED, \FTP_MOREDATA])]
function ftp_nb_continue(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp): int
{
}
/**
 ...
 */
#[EV([\FTP_FAILED, \FTP_FINISHED, \FTP_MOREDATA])]
function ftp_nb_put(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, string $remote_filename, string $local_filename, #[EV([\FTP_ASCII, \FTP_BINARY])] #[PhpStormStubsElementAvailable(from: '5.3', to: '7.2')] int $mode, #[EV([\FTP_ASCII, \FTP_BINARY])] #[PhpStormStubsElementAvailable(from: '7.3')] int $mode = \FTP_BINARY, int $offset = 0): int|false
{
}
/**
 ...
 */
#[EV([\FTP_FAILED, \FTP_FINISHED, \FTP_MOREDATA])]
function ftp_nb_fput(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp, string $remote_filename, $stream, #[EV([\FTP_ASCII, \FTP_BINARY])] #[PhpStormStubsElementAvailable(from: '5.3', to: '7.2')] int $mode, #[EV([\FTP_ASCII, \FTP_BINARY])] #[PhpStormStubsElementAvailable(from: '7.3')] int $mode = \FTP_BINARY, int $offset = 0): int
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ftp_quit(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\FTP\Connection'], default: 'resource')] $ftp): bool
{
}
/**
 * <p></p>
