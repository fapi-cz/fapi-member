 ...
 * @link https://php.net/manual/en/class.pharexception.php
 */
\class_alias('FapiMember\Library\PharException', 'PharException', \false);
/**
...
class Phar extends \RecursiveDirectoryIterator implements \RecursiveIterator, \SeekableIterator, \Countable, \ArrayAccess
{
     ...
     */
    final public static function running(#[PhpStormStubsElementAvailable(from: '5.3', to: '5.6')] $returnPhar, #[PhpStormStubsElementAvailable(from: '7.0')] bool $returnPhar = \true): string
    {
    }
    /**
     * (PHP &gt;= 5.3.0, PECL phar &gt;= 2.0.0)<br/>
     ...
     * @return void No value is returned.
     */
    final public static function webPhar(?string $alias = null, ?string $index = null, #[LanguageLevelTypeAware(['8.0' => 'string|null'], default: 'string')] $fileNotFoundScript = null, array $mimeTypes = [], ?callable $rewrite = null): void
    {
    }
    /**
 ...
 * @link https://php.net/manual/en/class.phar.php
 */
\class_alias('FapiMember\Library\Phar', 'Phar', \false);
/**
 ...
 * @link https://php.net/manual/en/class.phardata.php
 */
\class_alias('FapiMember\Library\PharData', 'PharData', \false);
/**
 ...
 * @link https://php.net/manual/en/class.pharfileinfo.php
 */
\class_alias('FapiMember\Library\PharFileInfo', 'PharFileInfo', \false);
// End of Phar v.2.0.1
