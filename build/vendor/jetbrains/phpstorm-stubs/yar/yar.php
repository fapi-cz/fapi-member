 ...
 * @link https://secure.php.net/manual/en/class.yar-server.php
 */
\class_alias('FapiMember\Library\Yar_Server', 'Yar_Server', \false);
class Yar_Client
{
    protected $_protocol;
    protected $_uri;
...
\class_alias('FapiMember\Library\Yar_Client', 'Yar_Client', \false);
...
\class_alias('FapiMember\Library\Yar_Concurrent_Client', 'Yar_Concurrent_Client', \false);
/**
 ...
 * @link https://secure.php.net/manual/en/class.yar-server-exception.php
 */
\class_alias('FapiMember\Library\Yar_Server_Exception', 'Yar_Server_Exception', \false);
/**
 ...
 * @link https://secure.php.net/manual/en/class.yar-client-exception.php
 */
\class_alias('FapiMember\Library\Yar_Client_Exception', 'Yar_Client_Exception', \false);
class Yar_Server_Request_Exception extends \Yar_Server_Exception
{
}
\class_alias('FapiMember\Library\Yar_Server_Request_Exception', 'Yar_Server_Request_Exception', \false);
class Yar_Server_Protocol_Exception extends \Yar_Server_Exception
{
}
\class_alias('FapiMember\Library\Yar_Server_Protocol_Exception', 'Yar_Server_Protocol_Exception', \false);
class Yar_Server_Packager_Exception extends \Yar_Server_Exception
{
}
\class_alias('FapiMember\Library\Yar_Server_Packager_Exception', 'Yar_Server_Packager_Exception', \false);
class Yar_Server_Output_Exception extends \Yar_Server_Exception
{
}
\class_alias('FapiMember\Library\Yar_Server_Output_Exception', 'Yar_Server_Output_Exception', \false);
class Yar_Client_Transport_Exception extends \Yar_Client_Exception
{
}
\class_alias('FapiMember\Library\Yar_Client_Transport_Exception', 'Yar_Client_Transport_Exception', \false);
class Yar_Client_Packager_Exception extends \Yar_Client_Exception
{
}
\class_alias('FapiMember\Library\Yar_Client_Packager_Exception', 'Yar_Client_Packager_Exception', \false);
class Yar_Client_Protocol_Exception extends \Yar_Client_Exception
{
}
\class_alias('FapiMember\Library\Yar_Client_Protocol_Exception', 'Yar_Client_Protocol_Exception', \false);
