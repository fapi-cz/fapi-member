 ...
 * @link https://secure.php.net/manual/en/class.zmq.php
 */
\class_alias('FapiMember\Library\ZMQ', 'ZMQ', \false);
/**
 * Class ZMQContext
 ...
 * @link https://secure.php.net/manual/en/class.zmqcontext.php
 */
\class_alias('FapiMember\Library\ZMQContext', 'ZMQContext', \false);
/**
 * Class ZMQSocket
 ...
 * @link https://secure.php.net/manual/en/class.zmqsocket.php
 */
\class_alias('FapiMember\Library\ZMQSocket', 'ZMQSocket', \false);
/**
 * Class ZMQPoll
 ...
 * @link https://secure.php.net/manual/en/class.zmqpoll.php
 */
\class_alias('FapiMember\Library\ZMQPoll', 'ZMQPoll', \false);
/**
 * Class ZMQDevice
 ...
 * @link https://secure.php.net/manual/en/class.zmqdevice.php
 */
\class_alias('FapiMember\Library\ZMQDevice', 'ZMQDevice', \false);
class ZMQException extends \Exception
{
}
\class_alias('FapiMember\Library\ZMQException', 'ZMQException', \false);
class ZMQContextException extends \ZMQException
{
}
\class_alias('FapiMember\Library\ZMQContextException', 'ZMQContextException', \false);
class ZMQSocketException extends \ZMQException
{
}
\class_alias('FapiMember\Library\ZMQSocketException', 'ZMQSocketException', \false);
class ZMQPollException extends \ZMQException
{
}
\class_alias('FapiMember\Library\ZMQPollException', 'ZMQPollException', \false);
class ZMQDeviceException extends \ZMQException
{
}
\class_alias('FapiMember\Library\ZMQDeviceException', 'ZMQDeviceException', \false);
