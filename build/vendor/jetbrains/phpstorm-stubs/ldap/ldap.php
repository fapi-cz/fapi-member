...
use FapiMember\Library\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware as PhpVersionAware;
use FapiMember\Library\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable as Available;
use LDAP\Result;
/**
 ...
 * @since 7.3
 */
function ldap_exop_refresh(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, string $dn, int $ttl): int|false
{
}
/**
 ...
 * @since 7.2
 */
function ldap_exop_whoami(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap): string|false
{
}
/**
...
function ldap_exop(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, string $request_oid, ?string $request_data, #[PhpVersionAware(["8.0" => "null|array"], default: "array")] $controls = null, &$response_data, &$response_oid)
{
}
/**
 ...
 * @since 7.2
 */
function ldap_parse_exop(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, #[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Result'], default: 'resource')] $result, #[Available(from: '7.2', to: '7.4')] &$response_data, #[Available(from: '8.0')] &$response_data = null, #[Available(from: '7.2', to: '7.4')] &$response_oid, #[Available(from: '8.0')] &$response_oid = null): bool
{
}
/**
 ...
 * @return bool
 */
function ldap_close(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap): bool
{
}
/**
 ...
 */
function ldap_bind(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, ?string $dn, ?string $password): bool
{
}
/**
 * Bind to LDAP directory
...
function ldap_bind_ext(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, ?string $dn, ?string $password, #[PhpVersionAware(["8.0" => "null|array"], default: "array")] $controls = null)
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ldap_sasl_bind(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, $binddn = null, $password = null, $sasl_mech = null, $sasl_realm = null, $sasl_authc_id = null, $sasl_authz_id = null, $props = null): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ldap_unbind(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap): bool
{
}
/**
 * Read an entry
...
function ldap_read(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, array|string $base, array|string $filter, array $attributes = [], int $attributes_only = 0, int $sizelimit = -1, int $timelimit = -1, int $deref = 0, #[Available(from: '7.3')] #[PhpVersionAware(["8.0" => "null|array"], default: "array")] $controls = null)
{
}
/**
 * Single-level search
 ...
 */
#[PhpVersionAware(['8.1' => 'LDAP\Result|array|false'], default: 'resource|false')]
function ldap_list(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, array|string $base, array|string $filter, array $attributes = [], int $attributes_only = 0, int $sizelimit = -1, int $timelimit = -1, int $deref = 0, #[Available(from: '7.3')] #[PhpVersionAware(["8.0" => "null|array"], default: "array")] $controls = null)
{
}
/**
 * Search LDAP tree
 ...
 */
#[PhpVersionAware(['8.1' => 'LDAP\Result|array|false'], default: 'resource|false')]
function ldap_search(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, array|string $base, array|string $filter, array $attributes = [], int $attributes_only = 0, int $sizelimit = -1, int $timelimit = -1, int $deref = 0, #[Available(from: '7.3')] #[PhpVersionAware(["8.0" => "null|array"], default: "array")] $controls = null)
{
}
/**
 * Free result memory
...
function ldap_count_entries(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, #[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Result'], default: 'resource')] $result)
{
}
/**
...
function ldap_first_entry(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, #[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Result'], default: 'resource')] $result)
{
}
/**
 ...
 */
#[PhpVersionAware(['8.1' => 'LDAP\ResultEntry|false'], default: 'resource|false')]
function ldap_next_entry(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, #[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\ResultEntry'], default: 'resource')] $entry)
{
}
/**
 ...
 * </pre>
 */
function ldap_get_entries(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, #[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Result'], default: 'resource')] $result): array|false
{
}
/**
 ...
 * error.
 */
function ldap_first_attribute(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, #[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\ResultEntry'], default: 'resource')] $entry): string|false
{
}
/**
 ...
 * error.
 */
function ldap_next_attribute(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, #[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\ResultEntry'], default: 'resource')] $entry): string|false
{
}
/**
 ...
 */
function ldap_get_attributes(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, #[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\ResultEntry'], default: 'resource')] $entry): array
{
}
/**
 ...
 */
function ldap_get_values(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, #[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\ResultEntry'], default: 'resource')] $entry, string $attribute): array|false
{
}
/**
 ...
 */
function ldap_get_values_len(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, #[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\ResultEntry'], default: 'resource')] $entry, string $attribute): array|false
{
}
/**
 ...
 */
function ldap_get_dn(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, #[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\ResultEntry'], default: 'resource')] $entry): string|false
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ldap_add(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, string $dn, array $entry, #[Available(from: '7.3')] #[PhpVersionAware(["8.0" => "null|array"], default: "array")] $controls = null): bool
{
}
/**
 * Add entries to LDAP directory
 ...
 */
#[PhpVersionAware(['8.1' => 'LDAP\Result|false'], default: 'resource|false')]
function ldap_add_ext(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, string $dn, array $entry, #[PhpVersionAware(["8.0" => "null|array"], default: "array")] $controls = null)
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ldap_delete(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, string $dn, #[Available(from: '7.3')] #[PhpVersionAware(["8.0" => "null|array"], default: "array")] $controls = null): bool
{
}
/**
 * Delete an entry from a directory
 ...
 */
#[PhpVersionAware(['8.1' => 'LDAP\Result|false'], default: 'resource|false')]
function ldap_delete_ext(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, string $dn, #[PhpVersionAware(["8.0" => "null|array"], default: "array")] $controls = null)
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ldap_modify(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, string $dn, array $entry, #[Available(from: '7.3')] #[PhpVersionAware(["8.0" => "null|array"], default: "array")] $controls = null): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ldap_mod_add(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, string $dn, array $entry, #[Available(from: '7.3')] #[PhpVersionAware(["8.0" => "null|array"], default: "array")] $controls = null): bool
{
}
/**
 * Add attribute values to current attributes
 ...
 */
#[PhpVersionAware(['8.1' => 'LDAP\Result|false'], default: 'resource|false')]
function ldap_mod_add_ext(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, string $dn, array $entry, #[PhpVersionAware(["8.0" => "null|array"], default: "array")] $controls = null)
{
}
/**
 * Replace attribute values with new ones
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ldap_mod_replace(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, string $dn, array $entry, #[Available(from: '7.3')] #[PhpVersionAware(["8.0" => "null|array"], default: "array")] $controls = null): bool
{
}
/**
 * Replace attribute values with new ones
 ...
 */
#[PhpVersionAware(['8.1' => 'LDAP\Result|false'], default: 'resource|false')]
function ldap_mod_replace_ext(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, string $dn, array $entry, #[PhpVersionAware(["8.0" => "null|array"], default: "array")] $controls = null)
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ldap_mod_del(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, string $dn, array $entry, #[Available(from: '7.3')] #[PhpVersionAware(["8.0" => "null|array"], default: "array")] $controls = null): bool
{
}
/**
 * Delete attribute values from current attributes
 ...
 */
#[PhpVersionAware(['8.1' => 'LDAP\Result|false'], default: 'resource|false')]
function ldap_mod_del_ext(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, string $dn, array $entry, #[PhpVersionAware(["8.0" => "null|array"], default: "array")] $controls = null)
{
}
/**
 ...
 * link.
 */
function ldap_errno(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap): int
{
}
/**
 ...
 */
function ldap_error(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap): string
{
}
/**
 ...
 */
function ldap_compare(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, string $dn, string $attribute, string $value, #[Available(from: '7.3')] #[PhpVersionAware(["8.0" => "null|array"], default: "array")] $controls = null): int|bool
{
}
/**
...
function ldap_sort(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, $result, string $sortfilter): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ldap_rename(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, string $dn, string $new_rdn, string $new_parent, bool $delete_old_rdn, #[Available(from: '7.3')] #[PhpVersionAware(["8.0" => "null|array"], default: "array")] $controls = null): bool
{
}
/**
 * Modify the name of an entry
 ...
 */
#[PhpVersionAware(['8.1' => 'LDAP\Result|false'], default: 'resource|false')]
function ldap_rename_ext(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, string $dn, string $new_rdn, string $new_parent, bool $delete_old_rdn, #[PhpVersionAware(["8.0" => "null|array"], default: "array")] $controls = null)
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ldap_get_option(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, int $option, #[Available(from: '5.3', to: '7.4')] &$value, #[Available(from: '8.0')] &$value = null): bool
{
}
/**
...
function ldap_first_reference(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, #[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Result'], default: 'resource')] $result)
{
}
/**
 * Get next reference
 ...
 */
#[PhpVersionAware(['8.1' => 'LDAP\ResultEntry|false'], default: 'resource')]
function ldap_next_reference(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, #[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\ResultEntry'], default: 'resource')] $entry)
{
}
/**
 ...
 * @return bool
 */
function ldap_parse_reference(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, #[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\ResultEntry'], default: 'resource')] $entry, &$referrals): bool
{
}
/**
 ...
 * @return bool
 */
function ldap_parse_result(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, #[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Result'], default: 'resource')] $result, &$error_code, &$matched_dn, &$error_message, &$referrals, #[Available(from: '7.3')] &$controls = null): bool
{
}
/**
 * Start TLS
 ...
 * @return bool
 */
function ldap_start_tls(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap): bool
{
}
/**
 ...
 * @return bool
 */
function ldap_set_rebind_proc(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, ?callable $callback): bool
{
}
/**
...
function ldap_control_paged_result(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, int $pagesize, $iscritical = \false, $cookie = ""): bool
{
}
/**
 ...
 */
#[Deprecated(since: "7.4")]
function ldap_control_paged_result_response(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, $result, &$cookie = null, &$estimated = null): bool
{
}
/**
 ...
 * @since 5.4
 */
function ldap_modify_batch(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, string $dn, array $modifications_info, #[Available(from: '7.3')] #[PhpVersionAware(["8.0" => "null|array"], default: "array")] $controls = null): bool
{
}
/**
 * @param resource $ldap
 ...
 * @since 8.0
 */
function ldap_count_references(#[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Connection'], default: 'resource')] $ldap, #[PhpVersionAware(['8.1' => 'FapiMember\Library\LDAP\Result'], default: 'resource')] $result): int
{
}
/**
 * @since 8.3
