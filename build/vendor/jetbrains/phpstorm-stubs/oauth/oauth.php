 ...
 * The OAuth extension provides a simple interface to interact with data providers using the OAuth HTTP specification to protect private resources.
 */
\class_alias('FapiMember\Library\OAuth', 'OAuth', \false);
...
\class_alias('FapiMember\Library\OAuthException', 'OAuthException', \false);
/**
 ...
 * Manages an OAuth provider class.
 */
\class_alias('FapiMember\Library\OAuthProvider', 'OAuthProvider', \false);
