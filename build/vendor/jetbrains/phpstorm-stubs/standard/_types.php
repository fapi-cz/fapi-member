 ...
 * @template-implements Iterator<TKey, TYield>
 */
\class_alias('FapiMember\Library\Generator', 'Generator', \false);
class ClosedGeneratorException extends \Exception
{
}
\class_alias('FapiMember\Library\ClosedGeneratorException', 'ClosedGeneratorException', \false);
namespace FapiMember\Library\___PHPSTORM_HELPERS;
