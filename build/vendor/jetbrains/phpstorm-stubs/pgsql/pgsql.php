...
// Start of pgsql v.
use FapiMember\Library\JetBrains\PhpStorm\ArrayShape;
use FapiMember\Library\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware;
use FapiMember\Library\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable;
/**
 ...
 * @since 5.6
 */
function pg_connect_poll(#[PhpStormStubsElementAvailable(from: '5.6', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection): int
{
}
/**
 ...
 */
function pg_connection_status(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection): int
{
}
/**
 ...
 */
function pg_connection_busy(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection): bool
{
}
/**
 ...
 */
function pg_connection_reset(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection): bool
{
}
/**
 ...
 * @since 5.6
 */
function pg_socket(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection)
{
}
/**
 ...
 * <i>param_name</i>.
 */
function pg_parameter_status(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $name): string|false
{
}
/**
 ...
 */
function pg_transaction_status(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection): int
{
}
/**
 * Execute a query
...
function pg_query(#[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $query)
{
}
/**
 ...
 */
#[LanguageLevelTypeAware(['8.1' => 'PgSql\Result|false'], default: 'resource|false')]
function pg_query_params(#[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, #[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $query = '', #[PhpStormStubsElementAvailable(from: '8.0')] $query, array $params)
{
}
/**
 ...
 */
#[LanguageLevelTypeAware(['8.1' => 'PgSql\Result|false'], default: 'resource|false')]
function pg_prepare(#[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, #[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] string $statement_name = '', #[PhpStormStubsElementAvailable(from: '8.0')] string $statement_name, string $query)
{
}
/**
 ...
 */
#[LanguageLevelTypeAware(['8.1' => 'PgSql\Result|false'], default: 'resource|false')]
function pg_execute(#[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, #[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] string $statement_name = '', #[PhpStormStubsElementAvailable(from: '8.0')] $statement_name, array $params)
{
}
/**
 ...
 */
function pg_send_query(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $query): int|bool
{
}
/**
 ...
 * Use <b>pg_get_result</b> to determine the query result.
 */
function pg_send_query_params(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $query, array $params): int|bool
{
}
/**
 ...
 */
function pg_send_prepare(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $statement_name, string $query): int|bool
{
}
/**
 ...
 * to determine the query result.
 */
function pg_send_execute(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $statement_name, array $params): int|bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pg_cancel_query(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection): bool
{
}
/**
 ...
 */
function pg_fetch_result(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, #[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $row = 0, #[PhpStormStubsElementAvailable(from: '8.0')] $row, string|int $field): string|false|null
{
}
/**
 ...
 */
function pg_fetch_row(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, ?int $row = null, int $mode = 2): array|false
{
}
/**
 ...
 * of rows in the set, there are no more rows, or on any other error.
 */
function pg_fetch_assoc(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, ?int $row = null): array|false
{
}
/**
 ...
 * of rows in the set, there are no more rows, or on any other error.
 */
function pg_fetch_array(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, ?int $row = null, int $mode = \PGSQL_BOTH): array|false
{
}
/**
 ...
 * of rows in the set, there are no more rows, or on any other error.
 */
function pg_fetch_object(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, ?int $row = null, string $class = 'stdClass', #[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $l = null, array $constructor_args = []): object|false
{
}
/**
...
function pg_fetch_all(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, int $mode = \PGSQL_ASSOC)
{
}
/**
 ...
 * </p>
 */
function pg_fetch_all_columns(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, int $field = 0): array
{
}
/**
 ...
 */
function pg_affected_rows(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result): int
{
}
/**
 ...
 */
#[LanguageLevelTypeAware(['8.1' => 'PgSql\Result|false'], default: 'resource|false')]
function pg_get_result(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection)
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pg_result_seek(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, int $row): bool
{
}
/**
 ...
 */
function pg_result_status(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, int $mode = \PGSQL_STATUS_LONG): string|int
{
}
/**
 * Free result memory
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pg_free_result(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result): bool
{
}
/**
 ...
 * no available OID.
 */
function pg_last_oid(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result): string|int|false
{
}
/**
 ...
 */
function pg_num_rows(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result): int
{
}
/**
 ...
 */
function pg_num_fields(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result): int
{
}
/**
 ...
 */
function pg_field_name(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, int $field): string
{
}
/**
 ...
 */
function pg_field_num(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, string $field): int
{
}
/**
 ...
 */
function pg_field_size(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, int $field): int
{
}
/**
 ...
 * on error.
 */
function pg_field_type(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, int $field): string
{
}
/**
 ...
 */
function pg_field_type_oid(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, int $field): string|int
{
}
/**
 ...
 */
function pg_field_prtlen(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, #[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $row = 0, #[PhpStormStubsElementAvailable(from: '8.0')] $row, string|int $field): int|false
{
}
/**
 ...
 */
function pg_field_is_null(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, #[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $row = 0, #[PhpStormStubsElementAvailable(from: '8.0')] $row, string|int $field): int|false
{
}
/**
 ...
 */
function pg_field_table(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, int $field, bool $oid_only = \false): string|int|false
{
}
/**
...
function pg_get_notify(#[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, int $mode = 1): array|false
{
}
/**
 ...
 */
function pg_get_pid(#[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection): int
{
}
/**
 ...
 */
function pg_result_error(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result): string|false
{
}
/**
 ...
 * on failure.
 */
function pg_result_error_field(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, int $field_code): string|false|null
{
}
/**
 ...
 * <b>FALSE</b> on error.
 */
function pg_last_notice(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, int $mode = \PGSQL_NOTICE_LAST): array|string|bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pg_put_line(#[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $query): bool
{
}
/**
 ...
 */
function pg_copy_to(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $table_name, string $separator = '	', string $null_as = '\\\\N'): array|false
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pg_copy_from(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $table_name, array $rows, string $separator = '	', string $null_as = '\\\\N'): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pg_trace(string $filename, string $mode = "w", #[LanguageLevelTypeAware(['8.1' => 'PgSql\Connection|null'], default: 'resource')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.3')] int $trace_mode = 0): bool
{
}
/**
 ...
 */
function pg_lo_create(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, $oid): string|int|false
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pg_lo_unlink(#[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, $oid): bool
{
}
/**
 * Open a large object
...
function pg_lo_open(#[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, $oid, string $mode)
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pg_lo_close(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Lob'], default: 'resource')] $lob): bool
{
}
/**
 * Read a large object
 ...
 */
function pg_lo_read(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Lob'], default: 'resource')] $lob, int $length = 8192): string|false
{
}
/**
 ...
 */
function pg_lo_write(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Lob'], default: 'resource')] $lob, string $data, ?int $length = null): int|false
{
}
/**
 ...
 */
function pg_lo_read_all(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Lob'], default: 'resource')] $lob): int
{
}
/**
 ...
 */
function pg_lo_import(#[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, #[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection = null, $pathname, $object_id = null): string|int|false
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pg_lo_export(#[PhpStormStubsElementAvailable('8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, #[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection = null, $oid, $pathname): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pg_lo_seek(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Lob'], default: 'resource')] $lob, int $offset, int $whence = \PGSQL_SEEK_CUR): bool
{
}
/**
 ...
 */
function pg_lo_tell(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Lob'], default: 'resource')] $lob): int
{
}
/**
 ...
 */
function pg_lo_truncate(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Lob'], default: 'resource')] $lob, #[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] int $size = 0, #[PhpStormStubsElementAvailable(from: '8.0')] int $size): bool
{
}
/**
 ...
 */
function pg_escape_string(#[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $string): string
{
}
/**
 ...
 * @return string A string containing the escaped data.
 */
function pg_escape_bytea(#[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $string): string
{
}
/**
 ...
 * @since 5.4.4
 */
function pg_escape_identifier(#[PhpStormStubsElementAvailable(from: '5.4', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $string): string|false
{
}
/**
 ...
 * @since 5.4.4
 */
function pg_escape_literal(#[PhpStormStubsElementAvailable(from: '5.4', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $string): string|false
{
}
/**
 ...
 * or <b>PGSQL_ERRORS_VERBOSE</b>.
 */
function pg_set_error_verbosity(#[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, int $verbosity): int|false
{
}
/**
 ...
 */
function pg_set_client_encoding(#[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $encoding): int
{
}
/**
 ...
 */
function pg_meta_data(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $table_name, #[PhpStormStubsElementAvailable(from: '8.0')] bool $extended = \false): array|false
{
}
/**
 ...
 */
function pg_convert(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $table_name, array $values, int $flags = 0): array|false
{
}
/**
...
function pg_insert(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $table_name, array $values, int $flags = \PGSQL_DML_EXEC)
{
}
/**
 * Update table
 ...
 * via <i>options</i>.
 */
function pg_update(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $table_name, array $values, array $conditions, int $flags = \PGSQL_DML_EXEC): string|bool
{
}
/**
 * Deletes records
 ...
 * via <i>options</i>.
 */
function pg_delete(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $table_name, array $conditions, int $flags = \PGSQL_DML_EXEC): string|bool
{
}
/**
 * Select records
 ...
 * via <i>options</i>.
 */
function pg_select(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $table_name, array $conditions, int $flags = \PGSQL_DML_EXEC, int $mode = \PGSQL_ASSOC): array|string|false
{
}
/**
 * @param $connection
 ...
 */
#[LanguageLevelTypeAware(['8.1' => 'PgSql\Result|false'], default: 'resource|false')]
function pg_exec(#[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $query)
{
}
/**
 * @param $result
 ...
 * @deprecated
 */
function pg_getlastoid(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result): string|int|false
{
}
/**
 * @param $result
 ...
 * @deprecated
 */
function pg_cmdtuples(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result): int
{
}
// TODO remove
/**
 ...
 * @deprecated
 */
function pg_numrows(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result): int
{
}
/**
 * @param $result
 ...
 * @deprecated
 */
function pg_numfields(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result): int
{
}
/**
 * @param $result
 ...
 * @deprecated
 */
function pg_fieldname(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, int $field): string
{
}
/**
 * @param $result
 ...
 * @deprecated
 */
function pg_fieldsize(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, int $field): int
{
}
/**
 * @param $result
 ...
 * @deprecated
 */
function pg_fieldtype(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, int $field): string
{
}
/**
 * @param $result
 ...
 * @deprecated
 */
function pg_fieldnum(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, string $field): int
{
}
/**
 * @param $result
 ...
 * @deprecated
 */
function pg_fieldprtlen(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, #[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $row = 0, #[PhpStormStubsElementAvailable(from: '8.0')] $row, string|int $field): int|false
{
}
/**
 * @param $result
 ...
 * @deprecated
 */
function pg_fieldisnull(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, #[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $row = 0, #[PhpStormStubsElementAvailable(from: '8.0')] $row, string|int $field): int|false
{
}
/**
 * @param $result
 ...
 * @deprecated
 */
function pg_freeresult(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result): bool
{
}
/**
 ...
 * @deprecated
 */
function pg_result(#[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Result'], default: 'resource')] $result, #[PhpStormStubsElementAvailable(from: '8.0')] $row, #[PhpStormStubsElementAvailable(from: '8.0')] string|int $field): string|null|false
{
}
/**
 * @param $lob
 * @deprecated
 */
function pg_loreadall(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Lob'], default: 'resource')] $lob): int
{
}
// TODO remove
/**
 ...
 * @deprecated
 */
function pg_locreate(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, $oid): string|int|false
{
}
/**
 * @param $connection
 ...
 * @deprecated
 */
function pg_lounlink(#[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, $oid): bool
{
}
/**
 * @param $connection
 ...
 */
#[LanguageLevelTypeAware(['8.1' => 'PgSql\Lob|false'], default: 'resource|false')]
function pg_loopen(#[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, $oid, string $mode)
{
}
/**
 * @param $lob
 ...
 * @deprecated
 */
function pg_loclose(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Lob'], default: 'resource')] $lob): bool
{
}
/**
 * @param $lob
 ...
 * @deprecated
 */
function pg_loread(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Lob'], default: 'resource')] $lob, int $length = 8192): string|false
{
}
/**
 * @param $lob
 ...
 * @deprecated
 */
function pg_lowrite(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Lob'], default: 'resource')] $lob, string $data, ?int $length): int|false
{
}
/**
 * @param $connection
 ...
 * @deprecated
 */
function pg_loimport(#[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, $filename, $oid): string|int|false
{
}
/**
 * @param $connection
 ...
 * @deprecated
 */
function pg_loexport(#[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, $oid, $filename): bool
{
}
/**
 * @param $connection [optional]
 ...
 * @deprecated
 */
function pg_setclientencoding(#[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $connection = null, #[PhpStormStubsElementAvailable(from: '8.0')] #[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection, string $encoding): int
{
}
/**
 ...
 */
function pg_consume_input(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection): bool
{
}
/**
 ...
 */
function pg_flush(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PgSql\Connection'], default: 'resource')] $connection): int|bool
{
}
/**
 * @since 8.3
