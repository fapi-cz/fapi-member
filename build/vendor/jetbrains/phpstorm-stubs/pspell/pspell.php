 ...
 */
#[LanguageLevelTypeAware(['8.1' => 'PSpell\Dictionary|false'], default: 'int|false')]
function pspell_new_config(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PSpell\Config'], default: 'int')] $config)
{
}
/**
 * Check a word
 ...
 */
function pspell_check(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PSpell\Dictionary'], default: 'int')] $dictionary, string $word): bool
{
}
/**
 ...
 */
function pspell_suggest(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PSpell\Dictionary'], default: 'int')] $dictionary, string $word): array|false
{
}
/**
 ...
 */
function pspell_store_replacement(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PSpell\Dictionary'], default: 'int')] $dictionary, string $misspelled, string $correct): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pspell_add_to_personal(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PSpell\Dictionary'], default: 'int')] $dictionary, string $word): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pspell_add_to_session(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PSpell\Dictionary'], default: 'int')] $dictionary, string $word): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pspell_clear_session(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PSpell\Dictionary'], default: 'int')] $dictionary): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pspell_save_wordlist(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PSpell\Dictionary'], default: 'int')] $dictionary): bool
{
}
/**
 ...
 */
#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PSpell\Config'], default: 'int')]
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pspell_config_runtogether(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PSpell\Config'], default: 'int')] $config, bool $allow): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pspell_config_mode(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PSpell\Config'], default: 'int')] $config, int $mode): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pspell_config_ignore(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PSpell\Config'], default: 'int')] $config, int $min_length): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pspell_config_personal(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PSpell\Config'], default: 'int')] $config, string $filename): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pspell_config_dict_dir(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PSpell\Config'], default: 'int')] $config, string $directory): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pspell_config_data_dir(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PSpell\Config'], default: 'int')] $config, string $directory): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pspell_config_repl(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PSpell\Config'], default: 'int')] $config, string $filename): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function pspell_config_save_repl(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\PSpell\Config'], default: 'int')] $config, bool $save): bool
{
}
