...
// Start of svn v.1.0.1
\class_alias('FapiMember\Library\Svn', 'Svn', \false);
class SvnWc
{
    public const NONE = 1;
...
\class_alias('FapiMember\Library\SvnWc', 'SvnWc', \false);
class SvnWcSchedule
{
...
\class_alias('FapiMember\Library\SvnWcSchedule', 'SvnWcSchedule', \false);
class SvnNode
{
    public const NONE = 0;
    public const FILE = 1;
...
\class_alias('FapiMember\Library\SvnNode', 'SvnNode', \false);
/**
 * (PECL svn &gt;= 0.1.0)<br/>
