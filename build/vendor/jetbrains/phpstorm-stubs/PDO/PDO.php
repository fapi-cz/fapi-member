 ...
 * @link https://php.net/manual/en/class.pdoexception.php
 */
\class_alias('FapiMember\Library\PDOException', 'PDOException', \false);
/**
 ...
 * @link https://php.net/manual/en/class.pdo.php
 */
\class_alias('FapiMember\Library\PDO', 'PDO', \false);
/**
 ...
 * @link https://php.net/manual/en/class.pdostatement.php
 */
\class_alias('FapiMember\Library\PDOStatement', 'PDOStatement', \false);
final class PDORow
{
    #[LanguageLevelTypeAware(['8.1' => 'string'], default: '')]
    public $queryString;
}
\class_alias('FapiMember\Library\PDORow', 'PDORow', \false);
/**
 * (PHP 5 &gt;= 5.1.3, PHP 7, PECL pdo &gt;= 1.0.3)<br/>
 * Return an array of available PDO drivers
 * @link https://php.net/manual/en/pdo.getavailabledrivers.php
