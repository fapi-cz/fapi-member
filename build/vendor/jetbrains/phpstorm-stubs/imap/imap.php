 ...
 */
function imap_reopen(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $mailbox, int $flags = 0, int $retries = 0): bool
{
}
/**
...
function imap_close(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, int $flags = 0)
{
}
/**
 ...
 */
function imap_num_msg(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap): int|false
{
}
/**
 ...
 * integer.
 */
function imap_num_recent(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap): int
{
}
/**
 ...
 */
function imap_headers(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap): array|false
{
}
/**
 ...
 * </dl>
 */
function imap_headerinfo(#[LanguageLevelTypeAware(['8.0' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, int $message_num, int $from_length = 0, int $subject_length = 0, #[PhpStormStubsElementAvailable(to: '7.4')] $default_host = null): \stdClass|false
{
}
/**
 ...
 */
function imap_body(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, int $message_num, int $flags = 0): string|false
{
}
/**
...
function imap_bodystruct(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, int $message_num, string $section)
{
}
/**
 ...
 * text string.
 */
function imap_fetchbody(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, int $message_num, string $section, int $flags = 0): string|false
{
}
/**
 ...
 * @since 5.3.6
 */
function imap_fetchmime(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, int $message_num, string $section, int $flags = 0): string|false
{
}
/**
 ...
 * @since 5.1.3
 */
function imap_savebody(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, $file, int $message_num, string $section = "", int $flags = 0): bool
{
}
/**
 ...
 */
function imap_fetchheader(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, int $message_num, int $flags = 0): string|false
{
}
/**
 ...
 * </table>
 */
function imap_fetchstructure(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, int $message_num, int $flags = 0): \stdClass|false
{
}
/**
 * Clears IMAP cache
 ...
 */
#[LanguageLevelTypeAware(['8.3' => 'true'], default: 'bool')]
function imap_gc(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, #[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] int $flags = 0, #[PhpStormStubsElementAvailable(from: '8.0')] int $flags)
{
}
/**
 ...
 */
#[LanguageLevelTypeAware(['8.3' => 'true'], default: 'bool')]
function imap_expunge(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap)
{
}
/**
 ...
 */
#[LanguageLevelTypeAware(['8.3' => 'true'], default: 'bool')]
function imap_delete(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $message_nums, int $flags = 0)
{
}
/**
 ...
 */
#[LanguageLevelTypeAware(['8.3' => 'true'], default: 'bool')]
function imap_undelete(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $message_nums, int $flags = 0)
{
}
/**
 ...
 */
function imap_check(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap): \stdClass|false
{
}
/**
 ...
 */
function imap_listscan(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $reference, string $pattern, string $content): array|false
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_mail_copy(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $message_nums, string $mailbox, int $flags = 0): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_mail_move(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $message_nums, string $mailbox, int $flags = 0): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_createmailbox(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $mailbox): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_renamemailbox(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $from, string $to): bool
{
}
/**
 * Delete a mailbox
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_deletemailbox(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $mailbox): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_subscribe(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $mailbox): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_unsubscribe(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $mailbox): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_append(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $folder, string $message, ?string $options = null, ?string $internal_date = null): bool
{
}
/**
 ...
 */
function imap_ping(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap): bool
{
}
/**
 ...
 */
#[LanguageLevelTypeAware(['8.1' => 'stdClass|false'], default: 'object')]
function imap_status(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $mailbox, int $flags)
{
}
/**
 * @param $stream_id
 ...
 * Returns <b>FALSE</b> on failure.
 */
function imap_mailboxmsginfo(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap): \stdClass
{
}
/**
 ...
 */
#[LanguageLevelTypeAware(['8.3' => 'true'], default: 'bool')]
function imap_setflag_full(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $sequence, string $flag, int $options = \NIL)
{
}
/**
 ...
 */
#[LanguageLevelTypeAware(['8.3' => 'true'], default: 'bool')]
function imap_clearflag_full(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $sequence, string $flag, int $options = 0)
{
}
/**
 ...
 * parameters.
 */
function imap_sort(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, int $criteria, #[LanguageLevelTypeAware(['8.0' => 'bool'], default: 'int')] $reverse, int $flags = 0, ?string $search_criteria = null, ?string $charset = null): array|false
{
}
/**
 ...
 */
function imap_uid(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, int $message_num): int|false
{
}
/**
 ...
 * <i>uid</i>.
 */
function imap_msgno(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, int $message_uid): int
{
}
/**
 ...
 */
function imap_list(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $reference, string $pattern): array|false
{
}
/**
 ...
 */
function imap_lsub(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $reference, string $pattern): array|false
{
}
/**
 ...
 */
function imap_fetch_overview(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $sequence, int $flags = 0): array|false
{
}
/**
 ...
 * </p>
 */
function imap_search(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $criteria, int $flags = \SE_FREE, string $charset = ""): array|false
{
}
/**
 ...
 * </p>
 */
function imap_thread(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, int $flags = \SE_FREE): array|false
{
}
/**
...
function imap_get_quota(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $quota_root): array|false
{
}
/**
 ...
 * from the server.
 */
function imap_get_quotaroot(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $mailbox): array|false
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_set_quota(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $quota_root, int $mailbox_size): bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_setacl(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $mailbox, string $user_id, string $rights): bool
{
}
/**
 ...
 */
function imap_getacl(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $mailbox): array|false
{
}
/**
 * @param $stream_id
 ...
 * @return array|false
 */
function imap_listmailbox(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $reference, string $pattern): array|false
{
}
/**
 ...
 * </p>
 */
function imap_getmailboxes(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $reference, string $pattern): array|false
{
}
/**
 ...
 * @param $content
 */
function imap_scanmailbox(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $reference, string $pattern, string $content): array|false
{
}
/**
 ...
 * @return array|false
 */
function imap_listsubscribed(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $reference, string $pattern): array|false
{
}
/**
 * List all the subscribed mailboxes
 ...
 * Only used by UW-IMAPD.
 */
function imap_getsubscribed(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $reference, string $pattern): array|false
{
}
/**
 * (PHP 4, PHP 5)<br/>
 ...
 */
function imap_fetchtext(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, int $message_num, int $flags = 0): string|false
{
}
/**
 * Alias of <b>imap_listscan</b>
 ...
 * @param $content
 */
function imap_scan(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $reference, string $pattern, string $content): array|false
{
}
/**
 ...
 * @param $mailbox
 */
function imap_create(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $mailbox): bool
{
}
/**
 ...
 * @param $to
 */
function imap_rename(#[LanguageLevelTypeAware(['8.1' => 'FapiMember\Library\IMAP\Connection'], default: 'resource')] $imap, string $from, string $to): bool
{
}
/**
